...
var ShowcaseCard = function ShowcaseCard(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_6__["useEffect"])(function () {
    if (user && snapshot && !snapshot.data()) {
      _utils_firebase__WEBPACK_IMPORTED_MODULE_16__["default"].firestore().doc("showcase/".concat(showcase.key)).set({
        comments: []
      });
    }
  }, [snapshot]);
  ...
  return __jsx(_components_Card__WEBPACK_IMPORTED_MODULE_10__["Card"], {
    ...
    __self: this
  }, StyledTitle)), description && __jsx(Paragraph, {
    type: "secondary",
    ellipsis: {
      rows: 4
    },
...
//# sourceMappingURL=index.js.99f8c6e658b6114c8928.hot-update.js.map