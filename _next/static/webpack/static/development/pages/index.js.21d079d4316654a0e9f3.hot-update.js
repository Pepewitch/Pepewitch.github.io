...
var Container = Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(react_spring__WEBPACK_IMPORTED_MODULE_4__["animated"].div).withConfig({
  ...
  componentId: "ifxw8-0"
})(["position:relative;display:grid;grid-template-columns:repeat(4,minmax(100px,1fr));grid-gap:25px;padding:25px;background:white;cursor:pointer;box-shadow:0px 10px 10px -5px rgba(0,0,0,0.05);will-change:width,height,border-radius;"]);
...
var TestChain = function TestChain() {
  ...
  var _useSpring = Object(react_spring__WEBPACK_IMPORTED_MODULE_4__["useSpring"])({
    ...
    to: {
      ...
      x = _useSpring.x,
      rest = Object(_babel_runtime_corejs2_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1__["default"])(_useSpring, ["size", "x"]);
...
//# sourceMappingURL=index.js.21d079d4316654a0e9f3.hot-update.js.map