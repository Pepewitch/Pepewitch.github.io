...
/* harmony import */ var antd_lib_comment_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! antd/lib/comment/style */ "./node_modules/antd/lib/comment/style/index.js");
/* harmony import */ var antd_lib_comment_style__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(antd_lib_comment_style__WEBPACK_IMPORTED_MODULE_0__);
...
var CommentList = function CommentList(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx(antd_lib_comment__WEBPACK_IMPORTED_MODULE_1___default.a, {
      // actions={actions}
      key: index,
      ...
      datetime: __jsx(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_3___default.a, {
        title: moment__WEBPACK_IMPORTED_MODULE_6___default()(comment.createdAt.toDate()).format("YYYY-MM-DD HH:mm:ss"),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 22
        },
...
/* harmony import */ var _components_Card__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/Card */ "./components/Card.tsx");
/* harmony import */ var _components_CommendBox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/CommendBox */ "./components/CommendBox.tsx");
/* harmony import */ var _components_CommentList__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/CommentList */ "./components/CommentList.tsx");
...
/* harmony import */ var _components_ResponsiveStackGrid__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/ResponsiveStackGrid */ "./components/ResponsiveStackGrid.tsx");
/* harmony import */ var _utils_firebase__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/firebase */ "./utils/firebase.ts");
/* harmony import */ var _utils_showcases__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../utils/showcases */ "./utils/showcases.ts");
...
var Title = antd_lib_typography__WEBPACK_IMPORTED_MODULE_3___default.a.Title,
    Paragraph = antd_lib_typography__WEBPACK_IMPORTED_MODULE_3___default.a.Paragraph;
...
var ShowcaseBody = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
...
var ShowcaseCard = function ShowcaseCard(_ref) {
  ...
  var _useAuthState = Object(react_firebase_hooks_auth__WEBPACK_IMPORTED_MODULE_5__["useAuthState"])(_utils_firebase__WEBPACK_IMPORTED_MODULE_14__["default"].auth()),
      _useAuthState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useAuthState, 3),
      user = _useAuthState2[0],
      initialising = _useAuthState2[1],
      error = _useAuthState2[2];

  var _useDocument = Object(react_firebase_hooks_firestore__WEBPACK_IMPORTED_MODULE_6__["useDocument"])(_utils_firebase__WEBPACK_IMPORTED_MODULE_14__["default"].firestore().doc("showcase/".concat(showcase.key))),
      _useDocument2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useDocument, 2),
      snapshot = _useDocument2[0],
      loading = _useDocument2[1];

  var comments = Object(react__WEBPACK_IMPORTED_MODULE_4__["useMemo"])(function () {
  ...
  return __jsx(_components_Card__WEBPACK_IMPORTED_MODULE_8__["Card"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46
    },
    ...
    __self: this
  }, __jsx(_components_Image__WEBPACK_IMPORTED_MODULE_12__["Image"], {
    src: src,
    title: title,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, description), comments && __jsx(_components_CommentList__WEBPACK_IMPORTED_MODULE_10__["CommentList"], {
    comments: comments,
    user: user,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }), __jsx(_components_CommendBox__WEBPACK_IMPORTED_MODULE_9__["CommendBox"], {
    user: user,
    showcase: showcase,
    onSubmit: function onSubmit(e) {
      if (comments) {
        _utils_firebase__WEBPACK_IMPORTED_MODULE_14__["default"].firestore().doc("showcase/".concat(showcase.key)).update({
...
var Index = function Index() {
  ...
  return __jsx(Container, {
    ...
    __self: this
  }), __jsx(_components_ResponsiveStackGrid__WEBPACK_IMPORTED_MODULE_13__["ResponsiveStackGrid"], {
    ...
    __self: this
  }, _utils_showcases__WEBPACK_IMPORTED_MODULE_15__["showcases"].map(function (showcase) {
...
//# sourceMappingURL=index.js.33daa86aa58fccfdfe1e.hot-update.js.map